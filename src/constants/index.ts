...
const STAKING_MAINNET = process.env.NEXT_PUBLIC_STAKING
const STAKING_SEPOLIA = process.env.NEXT_PUBLIC_STAKING_SEPOLIA
...
export const STAKING =
  REACT_APP_MODE === "PRODUCTION" ? STAKING_MAINNET : STAKING_SEPOLIA;
